...
#listfile = sDir + sfile
listfile = "c:\\python27\\twipro\\twi-src\\twi_list_100.txt"
category = ""
desc=""
listF = open(listfile,'r')
for twiacc in listF:
    	if len(twiacc)>0:
    		#print painters
            col_name = "'twi_acc','category','desc'"  
            valStr = twiacc+"','"+category+"','"+desc+""
            insertT("twipic_twiacc",col_name,valStr)
#	 print listfile
